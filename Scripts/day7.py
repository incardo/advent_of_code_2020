...
file_location = 'C://Users//incar//PycharmProjects//Advent_calendar//venv//day7_input.txt'

file_input = open('C://Users//incar//PycharmProjects//Advent_calendar//venv//day7_input.txt', 'r')
...
get_bag_data(file_location)
part_a(file_location)
part_b(file_location)